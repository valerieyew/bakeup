...
function SellerCompletedOrderDetails(props) {
    ...
    return (
        <div class="=flex fixed w-7/12 h-3/4 ml-80 mt-32 tracking-wider bg-black">
            <div class="grid grid-rows-4 grid-cols-4 gap-4 h-full p-6 shadow-lg border-2 border-gray-100 bg-white">
...
export default SellerCompletedOrderDetails;