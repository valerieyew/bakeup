...
function SellerUpcomingOrderDetails(props) {
    // let { id } = useParams();
            ...
            <div class="grid grid-rows-5 grid-cols-4 gap-4 h-full p-6 shadow-lg border-2 border-gray-100 bg-white">
                ...
                <div class="row-span-1 col-span-4 pt-4">
                    <div class="flex md:px-16 justify-around">
                        ...
                        class="row-span-1 w-48 py-4 text-gray-500 font-bold text-2xl bg-green-100 rounded-md hover:bg-green-300 hover:text-black">COMPLETE</button>
                    </div>
                </div>
            </div>
        </div>
...
export default SellerUpcomingOrderDetails;